...
const CAT_LABELS = {
  birds: 'Bird Points', eggs: 'Eggs', tucked_cards: 'Tucked Cards', goals: 'Goals',
}
...
export default function WingspanPocketStats({ stats }) {
  ...
  return (
    <CollapsibleCard title="🐦 Wingspan Pocket" subtitle={`${leaderLabel} · ${total} rounds`}>
      ...
      {total === 0 && (
        <p className="text-cream/40 text-sm text-center py-2">No Wingspan Pocket games yet!</p>
      )}
    </CollapsibleCard>
  )
}
