...
import { WINGSPAN_POCKET, WINGSPAN_POCKET_CATEGORIES } from '../../constants/games'
...
const emptyScores = () => ({
  birds: null, eggs: null, tucked_cards: null, goals: null,
})
...
export default function WingspanPocketForm({ onSave }) {
  ...
  const outcome = kayraTotal > matTotal ? KAYRA : matTotal > kayraTotal ? MAT : 'tie'
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-surface rounded-2xl overflow-hidden border border-white/10">
        ...
        {/* Rows */}
        {WINGSPAN_POCKET_CATEGORIES.map((cat) => (
